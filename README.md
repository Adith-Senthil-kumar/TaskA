# Task A — Offline-First Order Management App
...
This is the app a delivery driver holds while working a route. It shows the
...
documented in [task-a-app/DEPLOY.md](task-a-app/DEPLOY.md).
